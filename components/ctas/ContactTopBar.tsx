...
const ContactTopBar = () => {
	return (
		<div
			className='w-full h-[40px] fixed top-0 left-0 z-50 flex justify-center md:justify-between items-center px-4 md:px-10  shadow-lg animate-fade-in
      bg-gradient-to-r from-cyan-500/40 to-blue-500/40 backdrop-blur-md border-b border-white/20'
		>
			{/* ✅ Left - Response Time */}
			...
			<div className='flex items-center gap-5'>
				{contactsList.map((contact, idx) => (
					...
					>
						<Image src={contact.icon} alt={contact.title} width={20} height={20} className='drop-shadow-md' />
