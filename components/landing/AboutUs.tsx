	...
	return (
		<div className='max-w-[1400px] mx-auto py-6 md:py-8 flex flex-col justify-center gap-8 px-3'>
			...
			<div className='flex flex-col md:flex-row justify-start md:justify-between gap-6 md:gap-8 '>
				...
				<div className='flex flex-col gap-4 w-full px-4 py-2 md:w-[640px]'>
			...
			<div className='w-full flex justify-center'>
				<Link
					href={'#craft'}
					className='mx-auto w-fit text-center text-lg hover:bg-cyan-400 px-6 py-2 rounded-full border border-cyan-400 hover:text-stone-800 font-semibold hover:scale-105'
				>
					{data.cta}
				</Link>
			</div>
