...
export default function ScreenErrorItem({ message = 'Page not found!', buttonLabel = 'Go Back', buttonLink }: ScreenErrorProps) {
	const router = useRouter();

	return (
		<div className='flex flex-col items-center justify-center h-screen text-center bg-gray-100 dark:bg-gray-900'>
			<Image src='/svg/404error.svg' alt='Error' width={300} height={300} className='mb-6' />
